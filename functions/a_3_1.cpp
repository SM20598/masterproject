...
void a_3_1(double l, const double in2[12], double a[3])
{
  ...
  t7 = l * l;
  t23 = t2 + t3;
  t14 = in2[0] * in2[0] + in2[3] * in2[3];
  t15 = t23 * t23;
  t16 = t2 * 2.0 + t3 * 2.0;
  t17 = 1.0 / (t14 * t14);
  t18 = 1.0 / rt_powd_snf(t14, 3.0);
  t19 = std::sqrt(t14);
  t20 = in2[6] * in2[6] * 2.0 + in2[9] * in2[9] * 2.0;
  ...
  t14 = l * t15;
  t2 = t7 * t15;
  a[1] = (((((in2[9] * t16 * t17 * (t24 - 1.0) * 2.0 -
              t15 * t18 * (t24 - 1.0) * in2[3] * 8.0) +
             t17 * t20 * (t24 - 1.0) * in2[3]) +
            in2[9] * l * t16 * t21 * t3) -
           t14 * t22 * t3 * in2[3] * 5.0) +
          l * t20 * t21 * t3 * in2[3] / 2.0) +
         t2 * t17 * t24 * in2[3];
  a[2] =
