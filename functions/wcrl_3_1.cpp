...
void wcrl_3_1(double l, const double in2[12], double wcrl[9])
{
  ...
  t31_tmp = l * t11 * t12;
  t9 = (in2[9] * t14 * t18 + t31_tmp * t17 * in2[3] / 2.0) -
       t11 * t15 * t18 * in2[3] / 2.0;
  wcrl[0] = 0.0;
  wcrl[1] = -t23;
  t14 = in2[0] * t12 * (t17 - 1.0);
  wcrl[2] =
      (t12 * t30 * (t5 + t4 * t17) + t30_tmp * t19 / 2.0) + t14 * t9 * in2[3];
  wcrl[3] = t23;
  wcrl[4] = 0.0;
  wcrl[5] = (t12 * t9 * (t4 + t5 * t17) + t14 * t30 * in2[3]) +
            t31_tmp * t19 * in2[3] / 2.0;
  wcrl[6] =
      -t15 * (((in2[6] * t4 * t16 + t2 * t16 * in2[3]) - t2 * t18 * in2[3]) +
              t3 * t18 * in2[3]);
  wcrl[7] =
