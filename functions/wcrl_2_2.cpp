...
void wcrl_2_2(double l, const double in2[8], double wcrl[9])
{
  ...
  t84 = in2[7] * t20 * t22 * t28 * t29 * in2[1];
  ...
  t3 = in2[2] * in2[7];
  t282_tmp = in2[2] * in2[5];
  t282 =
      ((((((((((((((in2[6] * t22 * t26 * t29 + b_t148_tmp * t44 / 2.0) -
                   t236_tmp * t23 * t26 * t29 / 2.0) +
                  t282_tmp * t16 * t20 * t28 * (t27 - 1.0) * in2[3]) +
                 t3 * t16 * t20 * t28 * (t27 - 1.0) * in2[1]) +
                in2[6] * t16 * t20 * t28 * (t27 - 1.0) * in2[1] * in2[3]) +
