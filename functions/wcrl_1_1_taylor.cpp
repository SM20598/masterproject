...
// wcrl_1_1_taylor.cpp
//
// Code generation for function 'wcrl_1_1_taylor'
//

// Include files
#include "wcrl_1_1_taylor.h"
#include "limits"
#include <cmath>
...
void wcrl_1_1_taylor(double l, const double in2[4], double wcrl[9])
{
  double t11;
  double t12;
  double t14;
  ...
  t30 = (in2[2] * t14 * t18 + t30_tmp * t17 / 2.0) -
        in2[0] * t11 * t15 * t18 / 2.0;
  t31_tmp = l * t11 * t12;
  t9 = (in2[3] * t14 * t18 + t31_tmp * t17 * in2[1] / 2.0) -
  ...
  wcrl[6] =
      t15 * (((in2[2] * t4 * t16 + t2 * t16 * in2[1]) - t2 * t18 * in2[1]) +
             t3 * t18 * in2[1]);
  wcrl[7] =
...
// End of code generation (wcrl_1_1_taylor.cpp)
