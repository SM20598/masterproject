...
void a_3_2(double l, const double in2[12], double a[3])
{
  ...
  t38 = std::sqrt(t26);
  t39 = t19 + t21;
  t40 = in2[8] * in2[8] * 2.0 + in2[9] * in2[9] * 2.0;
  t32 = t31 * t31;
  ...
  a[0] =
      (((((((((((((((((((((m_a_tmp * (t49 - 1.0) * -8.0 +
                      ...
                      g_a_tmp * t42 * t51) +
                     x_a_tmp * t49) -
                    in2[8] * t31 * t34 * (t50 - 1.0) * t5 * 2.0) -
                   in2[2] * t27 * t33 * t34 * (t50 - 1.0) * t26 * 8.0) -
                  in2[2] * t28 * t31 * t36 * (t50 - 1.0) * t26 * 8.0) +
                 i_a_tmp * t32 * t34 * (t50 - 1.0) * t5 * 2.0) +
                in2[2] * t30 * t31 * t35 * (t50 - 1.0) * t5 * 2.0) +
               b_a_tmp * t43 * t44 * t51 * t52 * 3.0) +
              n_a_tmp * t41 * t46 * t51 * t52 * 3.0) +
             in2[2] * t32 * t34 * t39 * (t50 - 1.0) * t26) +
            c_a_tmp * t35 * t40 * (t50 - 1.0) * t26) -
           in2[0] * t39 * t42 * t43 * t51 * t52 / 2.0) -
          in2[0] * t40 * t41 * t45 * t51 * t52 / 2.0) +
         in2[8] * t29 * t32 * t34 * (t50 - 1.0) * t26 * 2.0) +
        ((((((((((((((((((((in2[8] * t30 * t31 * t35 * (t50 - 1.0) * t26 * 2.0 -
                            d_a_tmp * t42 * t43 * t51 * t52) -
                           q_a_tmp * t41 * t45 * t51 * t52) -
                          j_a_tmp * in2[9] * t31 * t34 * (t49 - 1.0) *
                              (t50 - 1.0) * 2.0) -
                         in2[6] * in2[7] * t31 * t34 * (t49 - 1.0) *
                             (t50 - 1.0) * in2[3] * 2.0) -
              ...
              in2[8] * l * t30 * t31 * t45 * t52 * t26) +
             in2[2] * t12 * t28 * t31 * t35 * t50 * t26) -
       ...
       (((((((((((((((((j_a_tmp * t29 * t32 * t34 * (t49 - 1.0) * (t50 - 1.0) *
                 ...
                 m_a_tmp * t34 * (t49 - 1.0) * (t50 - 1.0) * in2[1] * in2[3] *
                     8.0) -
                n_a_tmp * t31 * t36 * (t49 - 1.0) * (t50 - 1.0) * in2[1] *
                    in2[3] * 8.0) +
               o_a_tmp * t34 * t39 * (t49 - 1.0) * (t50 - 1.0) * in2[1] *
                   in2[3]) +
              in2[0] * t31 * t35 * t40 * (t49 - 1.0) * (t50 - 1.0) * in2[1] *
                  in2[3]) +
             p_a_tmp * t34 * (t49 - 1.0) * (t50 - 1.0) * in2[1] * in2[3] *
                 2.0) +
            q_a_tmp * t31 * t35 * (t49 - 1.0) * (t50 - 1.0) * in2[1] * in2[3] *
                2.0) +
           r_a_tmp * t29 * t34 * t42 * t51 * (t50 - 1.0) * in2[3]) +
          s_a_tmp * t29 * t34 * t42 * t51 * (t50 - 1.0) * in2[1]) +
         r_a_tmp * t30 * t31 * t45 * t52 * (t49 - 1.0) * in2[3]) +
        s_a_tmp * t30 * t31 * t45 * t52 * (t49 - 1.0) * in2[1])) +
      (((((((((((e_a_tmp * t34 * t44 * t51 * (t50 - 1.0) * in2[1] * in2[3] *
                     -5.0 -
                 t_a_tmp * t31 * t46 * t52 * (t49 - 1.0) * in2[1] * in2[3] *
                     5.0) +
                u_a_tmp * t39 * t42 * t51 * (t50 - 1.0) * in2[1] * in2[3] /
                    2.0) +
               v_a_tmp * t40 * t45 * t52 * (t49 - 1.0) * in2[1] * in2[3] /
                   2.0) +
              g_a_tmp * t34 * t42 * t51 * (t50 - 1.0) * in2[1] * in2[3]) +
             w_a_tmp * t31 * t45 * t52 * (t49 - 1.0) * in2[1] * in2[3]) +
            x_a_tmp * t34 * t49 * (t50 - 1.0) * in2[1] * in2[3]) +
           y_a_tmp * t31 * t35 * t50 * (t49 - 1.0) * in2[1] * in2[3]) -
          ab_a_tmp * t32 * t35 * (t49 - 1.0) * (t50 - 1.0) * in2[1] * in2[3] *
              2.0) -
         l_a_tmp * t32 * t45 * t52 * (t49 - 1.0) * in2[1] * in2[3]) -
        l_a_tmp * t35 * t42 * t51 * (t50 - 1.0) * in2[1] * in2[3]) -
       bb_a_tmp * t42 * t45 * t51 * t52 * in2[1] * in2[3] / 2.0);
  a_tmp = in2[7] * t29;
  b_a_tmp = t27 * t33;
  b_a_tmp_tmp = in2[7] * l;
  ...
  g_a_tmp = t12 * t28;
  h_a_tmp = t29 * t30;
  c_a_tmp_tmp = in2[0] * in2[2];
  i_a_tmp = c_a_tmp_tmp * in2[7];
  j_a_tmp = in2[0] * in2[8];
  k_a_tmp = in2[2] * in2[6];
  l_a_tmp = l * t29 * t30;
  m_a_tmp = i_a_tmp * l;
  ...
  a[1] =
      ((((((((((((((((((((((a_tmp * t32 * (t49 - 1.0) * 2.0 -
                            b_a_tmp * (t49 - 1.0) * in2[1] * 8.0) +
                           t32 * t39 * (t49 - 1.0) * in2[1]) -
                         ...
                         c_a_tmp * t42 * t51) -
                        in2[9] * t31 * t34 * (t50 - 1.0) * t66 * 2.0) -
                       d_a_tmp * t44 * t51 * in2[1] * 5.0) +
                      y_a_tmp * t42 * t51 * in2[1] / 2.0) +
                     a_tmp_tmp * t32 * t49 * in2[1]) +
             ...
             t27 * t43 * t44 * t51 * t52 * in2[1] * 3.0) +
            t30 * t31 * t35 * (t50 - 1.0) * t66 * in2[3] * 2.0) +
           t28 * t41 * t46 * t51 * t52 * in2[1] * 3.0) +
          t32 * t34 * t39 * (t50 - 1.0) * t60 * in2[3]) +
         t31 * t35 * t40 * (t50 - 1.0) * t60 * in2[3]) +
        (((((((((((((((((((s_a_tmp * t43 * t51 * t52 * in2[1] * -0.5 -
                           t40 * t41 * t45 * t51 * t52 * in2[1] / 2.0) -
                          j_a_tmp * in2[7] * t31 * t34 * (t49 - 1.0) *
                              (t50 - 1.0) * 2.0) -
                         k_a_tmp * in2[7] * t31 * t34 * (t49 - 1.0) *
                             (t50 - 1.0) * 2.0) -
                      ...
                      t3 * t34 * t41 * t50 * t51) +
                     t5 * t31 * t45 * t52 * t60) -
                    t_a_tmp * t43 * t49 * t52 * in2[1] * 3.0) -
                   w_a_tmp * t41 * t50 * t51 * in2[1] * 3.0) +
                  u_a_tmp * t43 * t49 * t52 * in2[1] / 2.0) +
                 x_a_tmp * t41 * t50 * t51 * in2[1] / 2.0) -
            ...
            v_a_tmp * t43 * t51 * t52 * in2[1]) -
           g_a_tmp * t41 * t45 * t51 * t52 * in2[1]) -
          h_a_tmp * t32 * t35 * (t50 - 1.0) * t60 * in2[3] * 2.0) +
         h_a_tmp * t42 * t45 * t51 * t52 * in2[1] / 2.0)) +
       (((((((((((((((((t26 * t34 * t49 * t50 * in2[1] / 2.0 +
                      ...
                      bb_a_tmp * t33 * t34 * (t49 - 1.0) * (t50 - 1.0) *
                          in2[1] * 8.0) -
                     db_a_tmp * t31 * t36 * (t49 - 1.0) * (t50 - 1.0) * in2[1] *
                         8.0) +
                    c_a_tmp_tmp * t32 * t34 * t39 * (t49 - 1.0) * (t50 - 1.0) *
                        in2[1]) +
                   c_a_tmp_tmp * t31 * t35 * t40 * (t49 - 1.0) * (t50 - 1.0) *
                       in2[1]) +
                  eb_a_tmp * t32 * t34 * (t49 - 1.0) * (t50 - 1.0) * in2[1] *
                      2.0) +
                 fb_a_tmp * t32 * t34 * (t49 - 1.0) * (t50 - 1.0) * in2[1] *
                     2.0) +
                gb_a_tmp * t31 * t35 * (t49 - 1.0) * (t50 - 1.0) * in2[1] *
                    2.0) +
               hb_a_tmp * t31 * t35 * (t49 - 1.0) * (t50 - 1.0) * in2[1] *
                   2.0) -
              t25 * t45 * t49 * t52 * in2[1] / 2.0) -
             l_a_tmp * t34 * t42 * t50 * t51 * in2[1] / 2.0) -
            l_a_tmp * t32 * t45 * t52 * t60 * in2[3]) +
           m_a_tmp * t29 * t34 * t42 * t51 * (t50 - 1.0)) +
          m_a_tmp * t30 * t31 * t45 * t52 * (t49 - 1.0)) -
         t38 * t34 * t44 * t51 * (t50 - 1.0) * in2[1] * 5.0) -
        t13 * t31 * t46 * t52 * (t49 - 1.0) * in2[1] * 5.0)) +
      (((((((((((n_a_tmp * t34 * t39 * t42 * t51 * (t50 - 1.0) * in2[1] / 2.0 +
                 t6 * t40 * t45 * t52 * (t49 - 1.0) * in2[1] / 2.0) +
                t15 * t34 * t42 * t51 * (t50 - 1.0) * in2[1]) +
               t17 * t34 * t42 * t51 * (t50 - 1.0) * in2[1]) +
              o_a_tmp * t31 * t45 * t52 * (t49 - 1.0) * in2[1]) +
             p_a_tmp * t31 * t45 * t52 * (t49 - 1.0) * in2[1]) +
            t12 * t32 * t34 * t49 * (t50 - 1.0) * in2[1]) +
           t2 * t31 * t35 * t50 * (t49 - 1.0) * in2[1]) -
          lb_a_tmp * t32 * t35 * (t49 - 1.0) * (t50 - 1.0) * in2[1] * 2.0) -
         r_a_tmp * t32 * t45 * t52 * (t49 - 1.0) * in2[1]) -
        r_a_tmp * t35 * t42 * t51 * (t50 - 1.0) * in2[1]) -
       q_a_tmp * t42 * t45 * t51 * t52 * in2[1] / 2.0);
  a[2] =
      ((((((((((((((((((((((((t27 * t44 * t51 * 3.0 - s_a_tmp * t51 / 2.0) -
                 ...
                 in2[7] * in2[9] * t34 * t41 * t51 * (t50 - 1.0) * 2.0) +
        ...
        (((((((((((((((((-in2[7] * t29 * t34 * t42 * t51 * (t50 - 1.0) *
                             in2[3] -
                         ib_a_tmp * t34 * t42 * t51 * (t50 - 1.0) * in2[1]) -
                        jb_a_tmp * t35 * t41 * t51 * (t50 - 1.0) * in2[3] *
                            2.0) -
                       kb_a_tmp * t35 * t41 * t51 * (t50 - 1.0) * in2[1] *
                           2.0) +
                      l_a_tmp * t41 * t45 * t51 * t52 / 2.0) -
                     t37 * t34 * t41 * t50 * t51 / 2.0) +
                    t27 * t34 * t44 * t51 * (t50 - 1.0) * in2[1] * in2[3] *
                        3.0) +
                   t28 * t36 * t41 * t51 * (t50 - 1.0) * in2[1] * in2[3] *
                       8.0) -
                  t34 * t39 * t42 * t51 * (t50 - 1.0) * in2[1] * in2[3] / 2.0) -
                 t35 * t40 * t41 * t51 * (t50 - 1.0) * in2[1] * in2[3]) -
                t_a_tmp * t34 * t49 * (t50 - 1.0) * in2[1] * in2[3] * 3.0) +
               f_a_tmp * t34 * t39 * t49 * (t50 - 1.0) * in2[1] * in2[3] /
                   2.0) +
              e_a_tmp * t41 * t46 * t51 * t52 * in2[1] * in2[3] * 5.0) -
             l * t40 * t41 * t45 * t51 * t52 * in2[1] * in2[3] / 2.0) -
            g_a_tmp * t35 * t41 * t50 * t51 * in2[1] * in2[3]) -
           a_tmp_tmp * t34 * t42 * t51 * (t50 - 1.0) * in2[1] * in2[3]) +
          h_a_tmp * t35 * t42 * t51 * (t50 - 1.0) * in2[1] * in2[3]) -
       ...
       (((((((((((((((((t6 * t34 * t39 * t49 * (t50 - 1.0) / 2.0 +
              ...
              nb_a_tmp * t29 * t31 * t34 * t49 * (t50 - 1.0) * in2[1]) -
             t3 * t41 * t45 * t51 * t52 * in2[3]) -
            t5 * t41 * t45 * t51 * t52 * in2[1]) -
           r_a_tmp * t31 * t35 * t49 * (t50 - 1.0)) +
          r_a_tmp * t42 * t45 * t51 * t52 / 2.0) -
         q_a_tmp * t31 * t45 * t49 * t52 / 2.0) -
        t25 * t35 * t49 * (t50 - 1.0) * in2[1] * in2[3])) +
      (l_a_tmp * t42 * t45 * t51 * t52 * in2[1] * in2[3] / 2.0 -
       t26 * t45 * t49 * t52 * in2[1] * in2[3] / 2.0);
}
