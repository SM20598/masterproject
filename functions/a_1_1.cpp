...
void a_1_1(double l, const double in2[4], double a[3])
{
  double t14;
  double t15;
  double t16;
  ...
  t19 = std::sqrt(t14);
  t20 = in2[2] * in2[2] * 2.0 + in2[3] * in2[3] * 2.0;
...
// End of code generation (a_1_1.cpp)
