...
void wcrl_3_2(double l, const double in2[12], double wcrl[9])
{
  ...
  t46_tmp = in2[0] * t20;
  t46 = t46_tmp * t27 * t28;
  t47 = in2[2] * t22 * t26 * t29;
  t52 = t20 * t27 * t28 * in2[1];
  ...
  t84 = in2[9] * t20 * t22 * t28 * t29 * in2[1];
  t85 = t20 * t22 * t28 * t29 * in2[1] * in2[3];
  t10 = t72_tmp * t12;
  t163 = t10 * t21 * t22 * t28 * t29 / 2.0;
  t164_tmp = t72_tmp * t13;
  t164 = t164_tmp * t20 * t23 * t28 * t29 / 2.0;
  t173_tmp = t12 * t21;
  t173 = t173_tmp * t22 * t28 * t29 * in2[1] * in2[3] / 2.0;
  t174 = t13 * t20 * t23 * t28 * t29 * in2[1] * in2[3] / 2.0;
  t40 = t4 + t2 * t26;
  t41 = t2 + t4 * t26;
  t42 = t5 + t3 * t27;
  t43 = t3 + t5 * t27;
  t108_tmp = t72_tmp * in2[7] * t14;
  t108 = t108_tmp * t16 * (t26 - 1.0) * (t27 - 1.0) * in2[3];
  t109_tmp = t72_tmp * in2[9];
  t109 = t109_tmp * t14 * t16 * (t26 - 1.0) * (t27 - 1.0) * in2[1];
  t284 = t72_tmp * t14;
  t110 = t284 * t16 * (t26 - 1.0) * (t27 - 1.0) * in2[1] * in2[3];
  t111_tmp = t73_tmp * t14;
  t111 = t111_tmp * t16 * (t26 - 1.0) * (t27 - 1.0) * in2[1] * in2[3];
  t112_tmp = t74_tmp * t14;
  t112 = t112_tmp * t16 * (t26 - 1.0) * (t27 - 1.0) * in2[1] * in2[3];
  t147_tmp_tmp = in2[0] * l;
  t282 = t147_tmp_tmp * t12;
  t147_tmp = t282 * t14;
  t147 = t147_tmp * t47 / 2.0;
  t148_tmp_tmp = in2[2] * l;
  t148_tmp = t148_tmp_tmp * t13;
  b_t148_tmp = t148_tmp * t16;
  t148 = b_t148_tmp * t46 / 2.0;
  t285 = l * t12;
  t153_tmp = t285 * t14;
  t153 = t153_tmp * t53 * in2[1] / 2.0;
  t154_tmp = l * t13;
  b_t154_tmp = t154_tmp * t16;
  t154 = b_t154_tmp * t52 * in2[3] / 2.0;
  t177_tmp = t10 * t15;
  t177 = t177_tmp * t16 * (t26 - 1.0) * (t27 - 1.0) * in2[1] * in2[3];
  t11 = t164_tmp * t14;
  t178 = t11 * t17 * (t26 - 1.0) * (t27 - 1.0) * in2[1] * in2[3];
  t197 = t10 * t16 * t21 * t28 * (t27 - 1.0) * in2[3] / 2.0;
  t198 = t11 * t23 * t29 * (t26 - 1.0) * in2[1] / 2.0;
  ...
  t237 = t12 * t16 * t21 * t28 * t43 * in2[1] / 2.0;
  t238_tmp = t13 * t14;
  ...
  t11 = in2[2] * t14;
  t3 = t11 * t22 * t29;
  t272 = (t46 + t10 * t22 * t29 * (t26 - 1.0) * in2[1] * in2[3]) + t3 * t40;
  t4 = in2[0] * t16 * t20 * t28;
  t273 = (t47 + in2[2] * t16 * t20 * t28 * (t27 - 1.0) * in2[1] * in2[3]) +
         t4 * t42;
  t8 = t14 * t22 * t29;
  t274 = (t52 + t284 * t22 * t29 * (t26 - 1.0) * in2[1]) + t8 * t41 * in2[3];
  t5 = t16 * t20 * t28;
  ...
  t277 = (-(t46_tmp * t22 * t28 * t29 * in2[3]) + t277_tmp * t43 * in2[1]) +
         b_t277_tmp * t40 * in2[3];
  t278 =
      (-(in2[2] * t20 * t22 * t28 * t29 * in2[1]) + t277_tmp * t42 * in2[1]) +
  ...
  t281 = ((((((((((((((d_t281_tmp * t27 * t28 + t147_tmp * t44 / 2.0) -
                    ...
                    c_t281_tmp * t14 * t22 * t29 * (t26 - 1.0) * in2[1]) +
                   t46_tmp * t22 * t29 * (t26 - 1.0) * in2[1] * in2[3]) +
                  t85 * t22 * t29 * t40) +
                 t10 * t14 * t16 * t27 * (t26 - 1.0) * in2[1] * in2[3] / 2.0) -
                t110 * t22 * t29 * (t26 - 1.0) * in2[1] * in2[3]) -
               t10 * t20 * t22 * t28 * t29 / 2.0) -
              g_t281_tmp * t23 * t29 * (t26 - 1.0) * in2[1] * in2[3] / 2.0) +
             t282 * t21 * t22 * t28 * t29 * in2[1] * in2[3] * -0.5) +
  ...
  t3 = in2[2] * in2[9];
  t282_tmp = in2[2] * in2[7];
  t282 =
      ((((((((((((((in2[8] * t22 * t26 * t29 + b_t148_tmp * t44 / 2.0) -
                   t236_tmp * t23 * t26 * t29 / 2.0) +
                  t282_tmp * t16 * t20 * t28 * (t27 - 1.0) * in2[3]) +
                 t3 * t16 * t20 * t28 * (t27 - 1.0) * in2[1]) +
                in2[8] * t16 * t20 * t28 * (t27 - 1.0) * in2[1] * in2[3]) +
               in2[6] * t16 * t20 * t28 * t42) +
              t10 * t14 * t16 * t26 * (t27 - 1.0) * in2[1] * in2[3] / 2.0) -
             t236_tmp * t17 * t20 * t28 * (t27 - 1.0) * in2[1] * in2[3]) -
            t10 * t20 * t22 * t28 * t29 / 2.0) -
           t281_tmp * t16 * t21 * t28 * (t27 - 1.0) * in2[1] * in2[3] / 2.0) +
          t148_tmp * t20 * t23 * t28 * t29 * in2[1] * in2[3] * -0.5) +
  ...
  t11 *= t13;
  t10 = t12 * t15;
  t72 = ((((((((((((((t83_tmp * t27 * t28 + t153_tmp * t44 * in2[1] / 2.0) -
                     t173_tmp * t27 * t28 * in2[1] / 2.0) +
                    t108_tmp * t22 * t29 * (t26 - 1.0)) +
                   t111_tmp * t22 * t29 * (t26 - 1.0) * in2[1]) +
                  t112_tmp * t22 * t29 * (t26 - 1.0) * in2[1]) +
                 in2[9] * t14 * t22 * t29 * t41) -
                t177_tmp * t22 * t29 * (t26 - 1.0) * in2[1]) -
               t154_tmp * t20 * t22 * t28 * t29 * in2[1] / 2.0) +
              t11 * t14 * t16 * t27 * (t26 - 1.0) * in2[1] / 2.0) -
             t198) +
            t2 * t21 * t22 * t28 * t29 * in2[1] * -0.5) +
           t154_tmp * t14 * t16 * t27 * t41 * in2[3] / 2.0) -
          t10 * t22 * t29 * t41 * in2[3]) -
         t238) +
        t8 * t161 * in2[3];
  t284 = ((((((((((((((in2[9] * t22 * t26 * t29 +
  ...
  t10 = ((((((((((((((((t282_tmp * t20 * t22 * t28 * t29 +
                        in2[8] * t20 * t22 * t28 * t29 * in2[1]) -
                       t7 * t42) -
                      t5 * t41) -
                     t8 * t42 * in2[1]) -
                    t6 * t41 * in2[3]) +
                   t153_tmp * t47 * in2[1] / 2.0) +
                  b_t148_tmp * t52 / 2.0) -
                 t281_tmp * t21 * t22 * t28 * t29 * in2[1] / 2.0) -
                t236_tmp * t20 * t23 * t28 * t29 * in2[1] / 2.0) +
               t4 * t42 * in2[1]) +
              t3 * t41 * in2[3]) +
             t2 * t42 * in2[1]) +
            t10 * t41 * in2[3]) +
