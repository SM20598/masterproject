...
void wcrl_3_3(double l, const double in2[12], double wcrl[9])
{
  ...
  t65_tmp = in2[0] * in2[2];
  t65 = t65_tmp * t41 * t42;
  t66 = t41 * t42 * in2[1] * in2[3];
  t67_tmp = in2[0] * t29;
  t67 = t67_tmp * t39 * t41;
  t68 = in2[2] * t31 * t38 * t42;
  t73 = t29 * t39 * t41 * in2[1];
  t74 = t31 * t38 * t42 * in2[3];
  t100_tmp = in2[0] * in2[8];
  t100 = t100_tmp * t29 * t31 * t41 * t42;
  t101_tmp = in2[2] * in2[6];
  t101 = t101_tmp * t29 * t31 * t41 * t42;
  t110_tmp = in2[7] * t29;
  t110 = t110_tmp * t31 * t41 * t42 * in2[3];
  t111 = in2[9] * t29 * t31 * t41 * t42 * in2[1];
  t59 = t5 + t2 * t38;
  t60 = t2 + t5 * t38;
  t61 = t6 + t3 * t39;
  t62 = t3 + t6 * t39;
  t63 = t7 + t4 * t40;
  t64 = t4 + t7 * t40;
  t135_tmp = t65_tmp * in2[7] * t20;
  t135 = t135_tmp * t22 * (t38 - 1.0) * (t39 - 1.0) * in2[3];
  t136_tmp = t65_tmp * in2[9];
  t136 = t136_tmp * t20 * t22 * (t38 - 1.0) * (t39 - 1.0) * in2[1];
  t16 = t65_tmp * t20;
  t137 = t16 * t22 * (t38 - 1.0) * (t39 - 1.0) * in2[1] * in2[3];
  t138_tmp = t100_tmp * t20;
  t138 = t138_tmp * t22 * (t38 - 1.0) * (t39 - 1.0) * in2[1] * in2[3];
  t483 = t101_tmp * t20;
  t139 = t483 * t22 * (t38 - 1.0) * (t39 - 1.0) * in2[1] * in2[3];
  t174_tmp_tmp = in2[0] * l;
  b_t174_tmp_tmp = t174_tmp_tmp * t17;
  t174_tmp = b_t174_tmp_tmp * t20;
  t174 = t174_tmp * t68 / 2.0;
  t175_tmp_tmp = in2[2] * l;
  t175_tmp = t175_tmp_tmp * t18;
  b_t175_tmp = t175_tmp * t22;
  t175 = b_t175_tmp * t67 / 2.0;
  t470 = l * t17;
  t180_tmp = t470 * t20;
  t180 = t180_tmp * t74 * in2[1] / 2.0;
  t469 = l * t18;
  t181_tmp = t469 * t22;
  t181 = t181_tmp * t73 * in2[3] / 2.0;
  ...
  t14 = t65_tmp * t17;
  t206_tmp = t14 * t21;
  t206 = t206_tmp * t22 * (t38 - 1.0) * (t39 - 1.0) * in2[1] * in2[3];
  t207_tmp_tmp = t65_tmp * t18;
  t15 = t207_tmp_tmp * t20;
  t207 = t15 * t23 * (t38 - 1.0) * (t39 - 1.0) * in2[1] * in2[3];
  t226 = t14 * t22 * t30 * t41 * (t39 - 1.0) * in2[3] / 2.0;
  t227 = t15 * t32 * t42 * (t38 - 1.0) * in2[1] / 2.0;
  ...
  t266 = t17 * t22 * t30 * t41 * t62 * in2[1] / 2.0;
  t267_tmp = t18 * t20;
  t267 = t267_tmp * t32 * t42 * t60 * in2[3] / 2.0;
  ...
  t15 = in2[2] * t20;
  t3 = t15 * t31 * t42;
  t302 = (t67 + t14 * t31 * t42 * (t38 - 1.0) * in2[1] * in2[3]) + t3 * t59;
  t5 = in2[0] * t22 * t29 * t41;
  t303 = (t68 + in2[2] * t22 * t29 * t41 * (t39 - 1.0) * in2[1] * in2[3]) +
         t5 * t61;
  t11 = t20 * t31 * t42;
  t304 = (t73 + t16 * t31 * t42 * (t38 - 1.0) * in2[1]) + t11 * t60 * in2[3];
  t6 = t22 * t29 * t41;
  t305 = (t74 + t65_tmp * t22 * t29 * t41 * (t39 - 1.0) * in2[3]) +
         t6 * t62 * in2[1];
  t27 = t20 * t22;
  t12 = t27 * t59;
  ...
  t325 = (-(t67_tmp * t31 * t41 * t42 * in2[3]) + t325_tmp * t62 * in2[1]) +
         b_t325_tmp * t59 * in2[3];
  t326 =
      (-(in2[2] * t29 * t31 * t41 * t42 * in2[1]) + t325_tmp * t61 * in2[1]) +
      b_t325_tmp * t60 * in2[3];
  t9 = t27 * t60;
  ...
  t463_tmp = in2[4] * t33 * t43;
  t464_tmp = t33 * t43;
  t14 = t174_tmp_tmp * t18;
  t467_tmp = in2[2] * t17;
  b_t467_tmp = in2[0] * t18;
  c_t467_tmp = in2[0] * in2[9];
  d_t467_tmp = in2[6] * t29;
  e_t467_tmp = in2[0] * in2[7] * t20;
  f_t467_tmp = in2[6] * t20;
  g_t467_tmp = in2[8] * t20;
  h_t467_tmp = t2 * t30;
  i_t467_tmp = t2 * t21;
  ...
  t467 = ((((((((((((((d_t467_tmp * t39 * t41 + t174_tmp * t38 * t39 / 2.0) -
                     ...
                     e_t467_tmp * t31 * t42 * (t38 - 1.0) * in2[3]) +
                    c_t467_tmp * t20 * t31 * t42 * (t38 - 1.0) * in2[1]) +
                   f_t467_tmp * t31 * t42 * (t38 - 1.0) * in2[1] * in2[3]) +
                  g_t467_tmp * t31 * t42 * t59) +
                 t14 * t20 * t22 * t39 * (t38 - 1.0) * in2[1] * in2[3] / 2.0) -
                i_t467_tmp * t31 * t42 * (t38 - 1.0) * in2[1] * in2[3]) -
               t14 * t29 * t31 * t41 * t42 / 2.0) -
              k_t467_tmp * t32 * t42 * (t38 - 1.0) * in2[1] * in2[3] / 2.0) +
  ...
  t2 = in2[2] * in2[9];
  t468_tmp = in2[2] * in2[7];
  t468 =
      ((((((((((((((in2[8] * t31 * t38 * t42 + b_t175_tmp * t38 * t39 / 2.0) -
                   t265_tmp * t32 * t38 * t42 / 2.0) +
                  t468_tmp * t22 * t29 * t41 * (t39 - 1.0) * in2[3]) +
                 t2 * t22 * t29 * t41 * (t39 - 1.0) * in2[1]) +
                in2[8] * t22 * t29 * t41 * (t39 - 1.0) * in2[1] * in2[3]) +
               in2[6] * t22 * t29 * t41 * t61) +
              t14 * t20 * t22 * t38 * (t39 - 1.0) * in2[1] * in2[3] / 2.0) -
             t265_tmp * t23 * t29 * t41 * (t39 - 1.0) * in2[1] * in2[3]) -
            t14 * t29 * t31 * t41 * t42 / 2.0) -
           t467_tmp * t22 * t30 * t41 * (t39 - 1.0) * in2[1] * in2[3] / 2.0) +
  ...
  t469 = ((((((((((((((t110_tmp * t39 * t41 +
                       t180_tmp * t38 * t39 * in2[1] / 2.0) -
                      t192_tmp_tmp * t39 * t41 * in2[1] / 2.0) +
                     t135_tmp * t31 * t42 * (t38 - 1.0)) +
                    t138_tmp * t31 * t42 * (t38 - 1.0) * in2[1]) +
                   t483 * t31 * t42 * (t38 - 1.0) * in2[1]) +
                  in2[9] * t20 * t31 * t42 * t60) -
                 t206_tmp * t31 * t42 * (t38 - 1.0) * in2[1]) -
                t15 * t31 * t41 * t42 * in2[1] / 2.0) +
               t14 * t18 * t20 * t22 * t39 * (t38 - 1.0) * in2[1] / 2.0) -
              t227) +
             t470 * t30 * t31 * t65 * in2[1] * -0.5) +
            t469 * t20 * t22 * t39 * t60 * in2[3] / 2.0) -
           t16 * t31 * t42 * t60 * in2[3]) -
          t267) +
         t11 * t189 * in2[3];
  t470 = ((((((((((((((in2[9] * t31 * t38 * t42 +
                       t181_tmp * t38 * t39 * in2[3] / 2.0) -
                      t18 * t32 * t38 * t42 * in2[3] / 2.0) +
                     t136_tmp * t22 * t29 * t41 * (t39 - 1.0)) +
                    t100_tmp * t22 * t29 * t41 * (t39 - 1.0) * in2[3]) +
                   t101_tmp * t22 * t29 * t41 * (t39 - 1.0) * in2[3]) +
                  in2[7] * t22 * t29 * t41 * t62) -
                 t207_tmp_tmp * t23 * t29 * t41 * (t39 - 1.0) * in2[3]) -
                t8 * t31 * t41 * t42 * in2[3] / 2.0) +
               t14 * t17 * t20 * t22 * t38 * (t39 - 1.0) * in2[3] / 2.0) -
              t226) +
             t15 * t32 * t65 * in2[3] * -0.5) +
            t180_tmp * t22 * t38 * t62 * in2[1] / 2.0) -
           t18 * t23 * t29 * t41 * t62 * in2[1]) -
          t266) +
         t6 * t190 * in2[1];
  t15 = t16 * t22;
  t14 = t267_tmp * t23;
  ...
  t227 = ((((((((((((((((t110 + t111) - t135) - t136) - t138) - t139) + t180) +
          ...
          t27 * t62 * t189) -
         t9 * t190;
  t135_tmp = in2[4] * in2[11] * t24 * (t40 - 1.0);
  t138_tmp = in2[10] * t24 * (t40 - 1.0);
  t65_tmp = in2[10] * t33 * t43;
  ...
  t251 = in2[4] * t24 * (t40 - 1.0);
  b_t174_tmp_tmp = t24 * t63;
  t66 = (-(in2[4] * t29 * t31 * t33 * t43 * t300) + t251 * t305 * in2[5]) +
        b_t174_tmp_tmp * t303;
  t9 = t24 * t64;
  ...
  t15 = ((((((((((((((((c_t467_tmp * t29 * t31 * t41 * t42 +
                        d_t467_tmp * t31 * t41 * t42 * in2[3]) -
                       t6 * t62) -
                      t11 * t59) -
                     t8 * t62 * in2[1]) -
                    t5 * t59 * in2[3]) +
                   t174_tmp * t74 / 2.0) +
                  t181_tmp * t67 * in2[3] / 2.0) -
                 h_t467_tmp * t31 * t41 * t42 * in2[3] / 2.0) -
                b_t467_tmp * t29 * t32 * t41 * t42 * in2[3] / 2.0) +
               t3 * t62 * in2[1]) +
              t2 * t59 * in2[3]) +
             t16 * t62 * in2[1]) +
            t14 * t59 * in2[3]) +
           t174_tmp_tmp * t266) +
          l * t265 * in2[3]) -
         b_t325_tmp * t186 * in2[3]) -
        t325_tmp * t190 * in2[1];
  t14 = ((((((((((((((((t468_tmp * t29 * t31 * t41 * t42 +
                        in2[8] * t29 * t31 * t41 * t42 * in2[1]) -
                       t6 * t61) -
                      t11 * t60) -
                     t8 * t61 * in2[1]) -
                    t5 * t60 * in2[3]) +
                   t180_tmp * t68 * in2[1] / 2.0) +
                  b_t175_tmp * t73 / 2.0) -
                 t467_tmp * t30 * t31 * t41 * t42 * in2[1] / 2.0) -
                t265_tmp * t29 * t32 * t41 * t42 * in2[1] / 2.0) +
               t3 * t61 * in2[1]) +
              t2 * t60 * in2[3]) +
             t16 * t61 * in2[1]) +
            t14 * t60 * in2[3]) +
  ...
  t15 = ((((((((((in2[10] * t29 * t31 * t33 * t43 * t300 +
                  b_t316_tmp * t301 / 2.0) -
